...
final class Version20180528131527 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, adresse VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, zip INT NOT NULL, pseudo VARCHAR(25) NOT NULL, password VARCHAR(60) NOT NULL, interet LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', statut TINYINT(1) NOT NULL, newsletter TINYINT(1) NOT NULL, perimetre_activite INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
