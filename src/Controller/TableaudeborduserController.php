...
class TableaudeborduserController extends Controller
{
    ...
    public function formulaire(Request $requete)
    {
        ...
        $formulaire = $this->createFormBuilder($infosform)
            ...
            ->add('emailinfos', TextType::class, array('label' => 'EMAIL',)  )
        ...
        return $this->render('form_infos_perso/index.html.twig',
            array(
    ...
    {
        return $this->render('form_infos_perso/infosformOK.html.twig');
    }
}
